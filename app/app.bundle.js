...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.getMainPart = function (num, divider) { return Math.floor(num / divider); };\nexports.getRemainder = function (num, divider) { return num % divider; };\n\n\n//# sourceURL=webpack:///./app/helpers/division.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar division_1 = __webpack_require__(/*! ./division */ \"./app/helpers/division.ts\");\nvar get_message_1 = __webpack_require__(/*! ./get-message */ \"./app/helpers/get-message.ts\");\nexports.getTextedNumber = function (num, divider) {\n    var mainNum = division_1.getMainPart(num, divider);\n    var restNum = division_1.getRemainder(num, divider);\n    var text = get_message_1.getMessage({ main: mainNum, remainder: restNum, divider: divider });\n    return text;\n};\n\n\n//# sourceURL=webpack:///./app/helpers/get-texted-number.ts?");
